...
keymap.set("n", "<leader>E", ":NvimTreeFocus<CR>", { desc = " Focus NvimTree", silent = true })
...
-- Cursor Movement
keymap.set("n", "<A-h>", "^", { desc = "Start of Line" })
keymap.set("n", "<A-l>", "$", { desc = "End of Line" })
...
keymap.set("n", "<leader>ee", "<cmd>NvimTreeToggle<CR>", { desc = " Toggle NvimTree" }) -- toggle file explorer
...
keymap.set("n", "<leader>bf", "<cmd>bfirst<CR>", { desc = "Open current buffer in new buffer" }) -- open current buffer in new buffer
keymap.set("n", "<leader>bl", "<cmd>blast<CR>", { desc = "Open current buffer in new buffer" }) -- open current buffer in new buffer
