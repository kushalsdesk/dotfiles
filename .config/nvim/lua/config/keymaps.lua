...
map("n", "<leader>cc", "<cmd>t.<CR>", { desc = "Clone the currentline below" })
...
-- Cursor Movement
map('n', '<A-h>', '^', { desc = "Start of Line" })
map('n', '<A-l>', '$', { desc = "End of Line" })
map('n', '<C-x>', 'a<BS><esc>', { desc = "Imitate Backspace" })
...
-- quit
map("n", "<C-q>", "<cmd>q!<cr>", { desc = "quits current" })
